...
// Create the SVG wrapper, append the SVG group that's gonna contain the graph,
// then shift it by margins.
const svg = d3
  .select("#scatter")
  .append("svg")
  .attr("width", svg_Width)
  .attr("height", svg_Height + 40); // more padding for label
...
(async function(){
  ...
  const age_Label = xlabelsGroup.append("text")
    .attr("x", 0)
    .attr("y", 60)
